...
// Other
export const SEARCH_RADIUS_DEFAULT = 25; // kilometer(s)
...
// Object search
export const OBJECT_SEARCH_PATH =
  '/immobilien-kaufen/test-immobilien-kaufen-und-vermieten-die-perfekte-altersvorsorge';
export const OBJECT_SEARCH_PATH_BASE = '/immobilien-kaufen/';
...
export const XANO_API_URL_BASE =
  'https://x8ki-letl-twmt.n7.xano.io/api:HEXuL5kJ';
export const XANO_API_URL_PATH = '/get_object_cms_href';
